...
export const DictSchema = z.object({
  ...
  "footer.privacy": z.string(),
  "auth.signup.consent": z.string(),
  "auth.signup.consent_link": z.string(),
  "auth.signup.error_consent": z.string(),
  ...
  "auth.signup.error_generic": z.string(),
  "auth.signup.error_exists": z.string(),
  "auth.signup.error_weak_password": z.string(),
  "auth.signup.error_rate_limit": z.string(),
...
export const es = DictSchema.parse({
  ...
  "auth.signup.consent": "He leído y acepto la",
  "auth.signup.consent_link": "política de privacidad",
  "auth.signup.error_consent": "Debes aceptar la política de privacidad para continuar.",
  ...
  "auth.signup.error_generic": "No se pudo crear la cuenta. Inténtalo de nuevo.",
  "auth.signup.error_exists": "Ya existe una cuenta con este correo. Inicia sesión.",
  "auth.signup.error_weak_password": "La contraseña es demasiado débil. Usa al menos 8 caracteres.",
  "auth.signup.error_rate_limit": "Demasiados intentos. Espera unos minutos y vuelve a probar.",
