...
export const en: Dict = DictSchema.parse({
  ...
  "auth.signup.consent": "I have read and accept the",
  "auth.signup.consent_link": "privacy policy",
  "auth.signup.error_consent": "You must accept the privacy policy to continue.",
  ...
  "auth.signup.error_generic": "Could not create the account. Please try again.",
  "auth.signup.error_exists": "An account with this email already exists. Please sign in.",
  "auth.signup.error_weak_password": "Password is too weak. Use at least 8 characters.",
  "auth.signup.error_rate_limit": "Too many attempts. Please wait a few minutes and try again.",
